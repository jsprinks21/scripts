...
# lutris
ver=$(lsb_release -sr); if [ $ver != "16.10" -a $ver != "17.04" -a $ver !=
"16.04" ]; then ver=16.04; fi;

echo "deb http://download.opensuse.org/repositories/home:/strycore/xUbuntu_$ver/
./" | sudo tee /etc/apt/sources.list.d/lutris.list;

wget -q
http://download.opensuse.org/repositories/home:/strycore/xUbuntu_$ver/Release.key
-O- | sudo apt-key add -;
...
wget -O ~/pia-v70-installer-linux.tar.gz
'https://installers.privateinternetaccess.com/download/pia-v70-installer-linux.tar.gz';
...
# discord
wget -O ~/discord-0.0.1.deb
'https://dl.discordapp.net/apps/linux/0.0.1/discord-0.0.1.deb';
gdebi ~/discord-0.0.1.deb;
rm ~/discord-0.0.1.deb;

# vmware
wget -O VMware-Player-12.5.7-5813279.x86_64.bundle
'https://download3.vmware.com/software/player/file/VMware-Player-12.5.7-5813279.x86_64.bundle';
